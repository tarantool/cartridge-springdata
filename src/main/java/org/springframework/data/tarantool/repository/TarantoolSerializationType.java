 ...
 *   <li>
 *     <p>
 *       <b>TUPLE</b> - can be used to accept flatten structures from Tarantool that don't have keys to map the incoming object
 *       to a java class object. For mapping, the keys(metadata) are obtained by calling the lua function <code>ddl.get_schema</code>.
 *       Accordingly, the returnType class must have a camelCase name corresponding to snake_cased space name in Tarantool,
 *       or this snake_cased name must be specified in the {@link Tuple} annotation.
 ...
 *         <ul>
 *           <li><a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/">box.space</a> function response</li>
